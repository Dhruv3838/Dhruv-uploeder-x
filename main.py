...
photologo = 'https://imghoster.co/ib/kavGyrWG1J86HW3_1746974749.jpg' #https://envs.sh/GV0.jpg
...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="👨‍💻 Owner", url="https://t.me/Dhruv10081")]])
...
async def help_button(client, callback_query):
    help_text = (
    f"╭━━━━━━━✦✧✦━━━━━━━╮\n"
    f"💥 🂾 ᴍʀ DHRUV ʙᴏᴛꜱ ᴄᴏᴍᴍᴀɴᴅꜱ\n"
    f"╰━━━━━━━✦✧✦━━━━━━━╯\n"
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"📌 ᴍᴀɪɴ ꜰᴇᴀᴛᴜʀᴇꜱ:\n\n"
    f"➥ /start – ʙᴏᴛ ꜱᴛᴀᴛᴜꜱ ᴄʜᴇᴄᴋ\n"
    f"➥ /drm – ᴇxᴛʀᴀᴄᴛ ꜰʀᴏᴍ .txt (ᴀᴜᴛᴏ)\n"
    f"➥ /y2t – ʏᴏᴜᴛᴜʙᴇ → .txt ᴄᴏɴᴠᴇʀᴛᴇʀ\n"
    f"➥ /t2t – ᴛᴇxᴛ → .txt ɢᴇɴᴇʀᴀᴛᴏʀ\n"
    f"➥ /stop – ᴄᴀɴᴄᴇʟ ʀᴜɴɴɪɴɢ ᴛᴀꜱᴋ\n"
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ \n"
    f"⚙️ ᴛᴏᴏʟꜱ & ꜱᴇᴛᴛɪɴɢꜱ: \n\n"
    f"➥ /cookies – ᴜᴘᴅᴀᴛᴇ ʏᴛ ᴄᴏᴏᴋɪᴇꜱ\n"
    f"➥ /getcookies – ɢᴇᴛ ᴄᴜʀʀᴇɴᴛ ᴄᴏᴏᴋɪᴇꜱ\n"
    f"➥ /id – ɢᴇᴛ ᴄʜᴀᴛ/ᴜꜱᴇʀ ɪᴅ\n"
    f"➥ /info – ᴡᴇʟᴄᴏᴍᴇ ᴅᴇᴛᴀɪʟꜱ\n"
    f"➥ /logs – ᴠɪᴇᴡ ʙᴏᴛ ᴀᴄᴛɪᴠɪᴛʏ\n"
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"💬 ᴄʜᴀᴛ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ:\n\n"
    f"➥ /add_chat <chat_id> – ᴀᴅᴅ ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀᴛ/ɢʀᴏᴜᴘ/ᴄʜᴀɴɴᴇʟ\n"
    f"➥ /remove_chat <chat_id> – ʀᴇᴍᴏᴠᴇ ᴄʜᴀᴛ\n"
    f"➥ /list_chats – ʟɪꜱᴛ ʏᴏᴜʀ ᴄʜᴀᴛꜱ\n"
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"👑 ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ:\n\n"
    f"➥ /adduser <user_id> <days> – ᴀᴅᴅ ᴜꜱᴇʀ\n"
    f"➥ /removeuser <user_id> – ʀᴇᴍᴏᴠᴇ ᴜꜱᴇʀ\n"
    f"➥ /checkuser <user_id> – ᴄʜᴇᴄᴋ ᴜꜱᴇʀ\n"
    f"➥ /users – ʟɪꜱᴛ ᴀʟʟ ᴜꜱᴇʀꜱ\n"
    f"➥ /diagnose <user_id> – ᴅɪᴀɢɴᴏꜱᴇ ᴜꜱᴇʀ\n"
    f"➥ /dbstatus – ᴄʜᴇᴄᴋ ᴅᴀᴛᴀ ꜱᴛᴀᴛᴜꜱ\n"
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"💡 ɴᴏᴛᴇ:\n\n"
    f"• ꜱᴇɴᴅ ᴀɴʏ ʟɪɴᴋ ꜰᴏʀ ᴀᴜᴛᴏ ᴇxᴛʀᴀᴄᴛ\n"
    f"• ꜱᴜᴘᴘᴏʀᴛꜱ ʙᴀᴛᴄʜ ᴘʀᴏᴄᴇꜱꜱɪɴɢ\n"
    f"• ʙᴏᴛ ᴍᴜꜱᴛ ʙᴇ ᴀᴅᴍɪɴ ɪɴ ᴄʜᴀᴛꜱ\n"
    f"• ᴀᴅᴍɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ᴀᴜᴛʜᴏʀɪᴢᴇᴅ ᴜꜱᴇʀꜱ ᴏɴʟʏ\n\n"
    f"╭────────⊰◆⊱────────╮\n"
    f" ➠ ᴍᴀᴅᴇ ʙʏ: [🂾 Mʀ DHRUV ʙᴏᴛꜱ](https://t.me/Dhruv10081) 💻\n"
    f"╰────────⊰◆⊱────────╯\n"
)
...
async def features_button(client, callback_query):
    features_text = (
    f"╭━━━━━━━✦✧✦━━━━━━━╮\n"
    f"💫 🂾 Mʀ DHRUV B𝗼𝘁𝘀 sᴇʀᴠɪᴄᴇs\n"
    f"╰━━━━━━━✦✧✦━━━━━━━╯\n"
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"
    f"🔹 sᴇʀᴠɪᴄᴇ mᴇɴᴜ:\n\n"
    f"➥ 📚 ᴀᴘᴘx ᴢɪᴘ v1, (v2 ᴘᴅғ)\n"
    f"➥ 🎓 ᴄʟᴀssᴘʟᴜs dʀᴍ + nᴅʀᴍ\n"
    f"➥ 🧑‍🏫 ᴘʜʏsɪᴄsᴡᴀʟʟᴀʜ (ᴘᴀᴜsᴇᴅ)\n"
    f"➥ 📚 ᴄᴀʀᴇᴇʀᴡɪʟʟ + ᴘᴅғ\n"
    f"➥ 🗞️ ᴋʜᴀɴ ɢs\n"
    f"➥ 🎓 sᴛᴜᴅʏ ɪQ dʀᴍ\n"
    f"➥ 🚀 ᴀᴘᴘx + ᴀᴘᴘx dᴇᴄ ᴘᴅғ\n"
    f"➥ 📚 vɪᴍᴇᴏ ᴘʀᴏᴛᴇᴄᴛɪᴏɴ\n"
    f"➥ 📙 bʀɪɢʜtcᴏvᴇ ᴘʀᴏᴛᴇᴄᴛɪᴏɴ\n"
    f"➥ 🗞️ vɪsɪᴏɴɪᴀs ᴘʀᴏᴛᴇᴄᴛɪᴏɴ\n"
    f"➥ 📝 ᴢᴏᴏᴍ vɪᴅᴇᴏ\n"
    f"➥ 📙 ᴀʟʟ nᴏɴ dʀᴍ + dᴇᴄ dʀᴍ\n"
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n\n"
    f"╭────────⊰◆⊱────────╮\n"
    f" ➠ M𝗮𝗱𝗲 B𝗼𝘁𝘀 : [🂾 DHRUV 𝗯𝗼𝘁𝘀](https://t.me/Dhruv10081) 💻\n"
    f"╰────────⊰◆⊱────────╯"
)
...
async def txt_handler(client: Client, m: Message):
    ...
    f"➥ /adduser <user_id> <days> – **ᴀᴅᴅ ᴜꜱᴇʀ**\n"
    f"➥ /removeuser <user_id> – **ʀᴇᴍᴏᴠᴇ ᴜꜱᴇʀ**\n"
    f"➥ /checkuser <user_id> – **ᴄʜᴇᴄᴋ ᴜꜱᴇʀ ꜱᴛᴀᴛᴜꜱ**\n"
    f"➥ /users – **ʟɪꜱᴛ ᴀʟʟ ᴜꜱᴇʀꜱ**\n"
    f"➥ /diagnose <user_id> – **ᴅɪᴀɢɴᴏꜱᴇ ᴜꜱᴇʀ ᴀᴜᴛʜ**\n"
    f"➥ /dbstatus – **ᴄʜᴇᴄᴋ ᴅᴀᴛᴀʙᴀꜱᴇ ꜱᴛᴀᴛᴜꜱ**\n"
    f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰\n"  
    f"💡 **𝗡𝗢𝗧𝗘:**\n\n"  
